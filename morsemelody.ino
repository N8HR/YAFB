...
void playMelody() 
{
  ...
  for (int thisNote = 0; thisNote < notes * 2; thisNote = thisNote + 2) 
  {
    ...
    // In my testing with the ESP32-S2-Saola-1 I noticed frequency was off by a
    //  factor of 80, so I correct that here. YMMV
    ledcWriteTone(ledc_channel, melody[thisNote] * 80);
